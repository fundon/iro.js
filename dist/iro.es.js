...
function IroSlider(props) {
    ...
    var value = Math.round(activeColor[props.sliderType]);
    if (props.sliderType === 'kelvin') {
        value = getCurrentSliderValue(props, activeColor);
        value = Math.ceil(value);
    }
    return (v("div", { className: "IroSliderWrapper", style: {
            display: 'flex',
            alignItems: 'center',
            marginTop: '12px'
        } },
        v("div", { className: "IroSliderLabel", style: { width: '50px', textAlign: "center" } }, props.label),
        v(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function (uid, rootProps, rootStyles) { return (v("div", Object.assign({}, rootProps, { className: "IroSlider", style: {
                position: 'relative',
        ...
        v("div", { className: "IroSliderValue", style: { width: '50px', textAlign: "center" } }, value)));
}
...
function IroWheel(props) {
    ...
    return (v("div", { className: "IroSliderWrapper", style: {
        ...
        v("div", { className: "IroSliderLabel", style: { width: '50px' } }),
        v(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function (uid, rootProps, rootStyles) { return (v("div", Object.assign({}, rootProps, { className: "IroWheel", style: Object.assign({}, {width: cssValue(width),
            ...
            colors.filter(function (color) { return color !== activeColor; }).map(function (color) { return (v(IroHandle, { isActive: false, index: color.index, fill: color.hslString, r: props.handleRadius, url: props.handleSvg, props: props.handleProps, x: handlePositions[color.index].x, y: handlePositions[color.index].y })); }),
            v(IroHandle, { isActive: true, index: activeColor.index, fill: activeColor.hslString, r: props.activeHandleRadius || props.handleRadius, url: props.handleSvg, props: props.handleProps, x: handlePositions[activeColor.index].x, y: handlePositions[activeColor.index].y }))); }),
        v("div", { className: "IroSliderValue", style: { width: '50px', position: 'absolute', bottom: 0, right: 30 } }, activeColor.hexString)));
}
